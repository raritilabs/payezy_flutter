...
class _FetchDataState extends State<FetchData> {
  ...
  Widget build(BuildContext context) {
    final fetchDataProvider =
        Provider.of<FetchDataProvider>(context, listen: true);
    return Scaffold(
                                              ...
                                              Container(
                                                ...
                                                child: Padding(
                                                  padding: EdgeInsets.symmetric(
                                                      ...
                                                      vertical: 0.3.h),
                                                  child: metrophobicText(
                                                      (snapshot2.data['extractedDetails']
                                                                      [index][
                                                                  'tx_status']) ==
                                                              'payment_received'
                                                          ? 'Awaiting settlement'
...
//Account No title
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  SizedBox(
                                                    child: robotoText(
                                                        '\$${snapshot2.data['extractedDetails'][index]['tx_cost'].toString()}.00',
                                                        size: 11.sp),
                                                  ),
                                                ],
                                              ),
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  SizedBox(
                                                    child: robotoText(
                                                        '\$ ${snapshot2.data['extractedDetails'][index]['usd_amount']}',
                                                        size: 11.sp),
                                                  ),
                                                  SizedBox(
                                                    child: robotoText('-',
                                                ...
                                                children: [
                                                  Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        SizedBox(
                                                          child: robotoText(
                                                              '${snapshot2.data['extractedDetails'][index]['exchange_rate']} INR',
                                                              size: 11.sp),
                                                        ),
                                                      ]),
                                                  GestureDetector(
                                              ...
                                              Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    SizedBox(
                                                      child: robotoText(
                                                          DateUtilsFunction.formatEpochTime(
                                                              int.parse(snapshot2
                                                                  .data[
                                                                      'extractedDetails']
                                                                      [index][
                            ...
                            itemCount:
                                snapshot2.data!['extractedDetails'].length,
                          ),
                        ),
                      ]),
                );
